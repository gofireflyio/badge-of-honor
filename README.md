# ![BADGE](banner-light.png#gh-light-mode-only) ![BADGE](banner-dark.png#gh-dark-mode-only)
...
#### ClickOps Specialist
![ClickOps Specialist](Cloud-Platform-Engineering/ClickOps-Specialist.png)
Prefers doing everything manually via UI clicks, rather than automating it using IaC.

#### Cloud Waste Maintainer
![Cloud Waste Maintainer](Cloud-Platform-Engineering/Cloud-Waste-Maintainer.png)
Doesn't optimize cloud resources, leading to wasteful expenditures.

#### Infra Drifter
![Infra Drifter](Cloud-Platform-Engineering/Infra-Drifter.png)
...
![Master of Vendor Lock-In](Cloud-Platform-Engineering/Master-of-Vendor-Lock-In.png)
...
![Accidental TF Destroyer](Cloud-Platform-Engineering/Accidental-TF-Destroyer.png)
...
![Cloud Cost Maximization Expert](Cloud-Platform-Engineering/Cloud-Cost-Maximization-Expert.png)
Selects the most expensive cloud services without optimizing for cost.

#### Bare Metal Ambassador
![Bare Metal Ambassador](Cloud-Platform-Engineering/Bare-Metal-Ambassador.png)
...
![Keeping Dev EC2 Running All Night](Cloud-Platform-Engineering/Keeping-Dev-EC2-Running-All-Night.png)
Forgets to shut down development instances leading to unnecessary cloud costs.

#### Cloud Complexity Coacher
![Cloud Complexity Coacher](Cloud-Platform-Engineering/Cloud-Complexity-Coacher.png)
...
![Distributed Monolith Architect](Site-Reliability-Engineering/Distributed-Monolith-Architect.png)
...
![Poor-Availability Architect](Site-Reliability-Engineering/Poor-Availability-Architect.png)
...
![Off-Call Duty Officer](Site-Reliability-Engineering/Off-Call-Duty-Officer.png)
Avoids being on-call for support.

#### Unscheduled Maintenance Specialist
![Unscheduled Maintenance Specialist](Site-Reliability-Engineering/Unscheduled-Maintenance-Specialist.png)
Frequently causes unplanned downtime due to their reckless approach to maintenance.

#### Inflexible Scalability Specialist
![Inflexible Scalability Specialist](Site-Reliability-Engineering/Inflexible-Scalability-Specialist.png)
...
![Direct-to-Prod Promoter](Site-Reliability-Engineering/Direct-to-Prod-Promoter.png)
Known for pushing changes directly to production, skipping important testing and staging environments.

#### Show-Stopper
![Show-Stopper](Site-Reliability-Engineering/Show-Stopper.png)
Makes a big deal out of minor issues. Loves crisis management.


## SecOps
#### Home IP Whitelister
![Home IP Whitelister](SecOps/Home-IP-Whitelister.png)
...
#### S3 Bucket Exposer
![S3 Bucket Exposer](SecOps/S3-Bucket-Exposer.png)
...
![Non-Compliant Compliance Expert](SecOps/Non-Compliant-Compliance-Expert.png)
Talks a lot about compliance but fails to implement compliant practices.

#### Most Privileged
![Most Privileged](SecOps/Most-Privileged.png)
...
#### Always Run as Root
![Always Run as Root](SecOps/Always-Run-as-Root.png)
...
![Cloud-Captive Security Specialist](SecOps/Cloud-Captive-Security-Specialist.png)
...
![Disclosure of Human Errors](Bonus-Badge/Disclosure-of-Human-Errors.png)
